...
const BottomControlBar = (props) => {
  return (
    <div class="fixed bottom-5 left-0 right-0 flex justify-center z-10">
      <div class="dark:hover:[&>*]:bg-neutral-800 hover:[&>*]:bg-[#bbb] dark:bg-black bg-[#fafafa]  dark:text-white rounded-md max-w-[230px] w-full text-center min-h-8 flex items-center justify-evenly p-1 shadow z-50">
